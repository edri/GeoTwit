...
},{"./src/Edit.Circle.Drag":2,"./src/Edit.Poly.Drag":3,"./src/Edit.Rectangle.Drag":4,"./src/Edit.SimpleShape.Drag":5,"./src/EditToolbar.Edit":6,"./src/Polygon.Centroid":7,"leaflet":14,"leaflet-draw":8,"leaflet-path-drag":9}],2:[function(require,module,exports){
/**
...
},{"./src/MultiPoly.Drag":10,"./src/Path.Drag":11,"./src/Path.Transform":12}],10:[function(require,module,exports){
(function() {
...
function loadStreamingResultsMap() {
    ...
    speedInterval = setInterval(function() {
        ...
        $.each(nbReceivedTweets, function(key, value) {
            ...
            // We wants to switch the hue color between 0 (red) and 120 (green), according to the average speed.
            var hueColorLevel =
            ...
            // We want to switch the lightness color level from 50% to 25%.
            // BSLC: 50
            // GSLC: 25
            ...
            console.log("hsl(" + hueColorLevel + ", 100%, " + lightnessColorLevel + "%)");
...
},{"leaflet-draw-drag":1,"leaflet.markercluster":13}]},{},[15]);
